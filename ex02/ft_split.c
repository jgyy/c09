...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/06 11:06:03 by jegoh             #+#    #+#             */
/*   Updated: 2023/08/07 19:40:14 by jegoh            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdlib.h>
...
int	main(int argc, char **argv)
{
	int		index;
	char	**split;
	char	*str = (argc == 3) ? argv[1] : "helloworldhowareyouiamfinethatgoo";
	char	*charset = (argc == 3) ? argv[2] : "abcdefgh";
